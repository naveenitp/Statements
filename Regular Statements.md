...
INTO OUTFILE '/tmp/without_basepackage_08032023.csv' FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\r\n';
...
Steup-1	update lovtable set value=2 where setting='BILL_EDIT_AFTER_DEACTIVATION';	
...
Select count(*) from  eb_bp_package_percent p inner join percentage t on p.bp_pack_percent_id=t.id where to_date>='2022-12-31' and to_date<='2024-02-29';
Select p.* from  eb_bp_package_percent p inner join percentage t on p.bp_pack_percent_id=t.id where to_date>='2022-12-31' and to_date<='2024-02-29'  limit 4;
...
select sum(amount) from acc_lco_payments where employee_id=77
select sum(deducted_deposit_amount) from eb_deducted_deposit_logs where reseller_id=77
select 212558.27-207677.99 
select deposit_amount from employee where employee_id=77 
...
http://app.ezycable.com/apps/webservices/update_employee_imei.php?imei=&employee_id=4860&prev_imei=0eeb17c0f5be82ae
...
php  /var/www/html/index.php report_scheduler  report_scheduler_cron_job 2024-05
...
delete from eb_processes where  start_time between '2019-04-05 00:00:00' and '2024-03-09 23:59:59' and status=1;

To update bulk operations
select * from eb_bulk_act_deact_file_content where trans_id='1712840105497'
update eb_bulk_act_deact_file_content set upload_date=now() where trans_id='1712247165204';
