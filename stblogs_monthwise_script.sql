...
WHERE
    s.dealer_id = 1  
    AND (cl.activation_date >= '2024-01-23 00:00:00'
    AND cl.activation_date <= '2024-01-23 23:59:59') INTO OUTFILE '/tmp/temp_act_logs_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

CREATE TEMPORARY TABLE IF NOT EXISTS temp_act_logs_table_20240123(
...
LOAD DATA INFILE '/tmp/temp_act_logs_20240123.csv' INTO TABLE temp_act_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
...
WHERE s.dealer_id=1 AND (cl.deactivation_date >= '2024-01-23 00:00:00'
    AND cl.deactivation_date <= '2024-01-23 23:59:59') INTO OUTFILE '/tmp/temp_deact_logs_data_test_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

CREATE TEMPORARY TABLE IF NOT EXISTS temp_deact_logs_table_20240123(
customer_name varchar(200),
serial_number varchar(200),
vc_number varchar(200),
action_type varchar(200),
...
LOAD DATA INFILE '/tmp/temp_deact_logs_data_test_20240123.csv' INTO TABLE temp_deact_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
...
LEFT JOIN customer c ON c.customer_id=cd.customer_id AND c.dealer_id=1 
WHERE e.dealer_id=1 AND (cms.sent_on >= '2024-01-23 00:00:00' AND cms.sent_on <= '2024-01-23 23:59:59') 
INTO OUTFILE '/tmp/temp_message_logs_data_test_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

CREATE TEMPORARY TABLE IF NOT EXISTS temp_message_logs_table_20240123(
customer_name varchar(200),
serial_number varchar(200),
vc_number varchar(200),
action_type varchar(200),
...
LOAD DATA INFILE '/tmp/temp_message_logs_data_test_20240123.csv' INTO TABLE temp_message_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
...
LEFT JOIN customer_device cd ON cd.customer_id = c.customer_id AND cd.dealer_id=1 AND (cf.activated_date >= COALESCE(cd.created_on,'0000-00-00 00:00:00') AND cf.activated_date <= COALESCE(cd.device_closed_on,'3000-12-31 11:59:59')) WHERE cf.activated_date<>'0000-00-00 00:00:00' AND cf.dealer_id=1 AND (cf.activated_date >= '2024-01-23 00:00:00' AND cf.activated_date <= '2024-01-23 23:59:59') INTO OUTFILE '/tmp/temp_fingerprint_logs_data_test_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

CREATE TEMPORARY TABLE IF NOT EXISTS temp_fingerprint_logs_table_20240123(
customer_name varchar(200),
serial_number varchar(200),
vc_number varchar(200),
action_type varchar(200),
...
LOAD DATA INFILE '/tmp/temp_fingerprint_logs_data_test_20240123.csv' INTO TABLE temp_fingerprint_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
...
WHERE pl.dealer_id=1  AND (pl.created_on >= '2024-01-23 00:00:00' AND pl.created_on <= '2024-01-23 23:59:59') INTO OUTFILE '/tmp/temp_pairing_logs_data_test_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
'; 

CREATE TEMPORARY TABLE IF NOT EXISTS temp_pairing_logs_table_20240123(
customer_name varchar(200),
serial_number varchar(200),
vc_number varchar(200),
action_type varchar(200),
...
LOAD DATA INFILE '/tmp/temp_pairing_logs_data_test_20240123.csv' INTO TABLE temp_pairing_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
...
CASE WHEN e.users_type IN ('DEALER', 'ADMIN', 'EMPLOYEE', 'SERVICE', 'TEAMLEAD') THEN COALESCE(CONCAT(CONVERT(e.first_name USING utf8mb4), ' ', CONVERT(e.last_name USING utf8mb4)), 'N/A')
    ...
    LEFT JOIN backend_setups bs ON bs.backend_setup_id = s.backend_setup_id AND bs.dealer_id=1 WHERE cl.act_type='R' and cl.dealer_id=1 AND (cl.date_time_stamp >= '2024-01-23 00:00:00' AND cl.date_time_stamp <= '2024-01-23 23:59:59') INTO OUTFILE '/tmp/temp_react_logs_data_test_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
'; 

CREATE TEMPORARY TABLE IF NOT EXISTS temp_react_logs_table_20240123(
customer_name varchar(200),
serial_number varchar(200),
vc_number varchar(200),
action_type varchar(200),
...
LOAD DATA INFILE '/tmp/temp_react_logs_data_test_20240123.csv' INTO TABLE temp_react_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
...
CASE WHEN e.users_type IN ('DEALER', 'ADMIN', 'EMPLOYEE', 'SERVICE', 'TEAMLEAD') THEN COALESCE(CONCAT(CONVERT(e.first_name USING utf8mb4), ' ', CONVERT(e.last_name USING utf8mb4)), 'N/A')
 ...
 LEFT JOIN eb_models em ON s.model_number = em.model_id 
 LEFT JOIN backend_setups bs ON bs.backend_setup_id = s.backend_setup_id AND bs.dealer_id=1 
 LEFT JOIN customer c ON c.customer_id = cd.customer_id WHERE s.status=3 AND s.defective_stock=0 AND s.dealer_id=1 AND (s.modified_date >= '2024-01-23 00:00:00' AND s.modified_date <= '2024-01-23 23:59:59') INTO OUTFILE '/tmp/temp_blacklist_logs_data_test_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
'; 

CREATE TEMPORARY TABLE IF NOT EXISTS temp_blacklist_logs_table_20240123(
customer_name varchar(200),
serial_number varchar(200),
vc_number varchar(200),
action_type varchar(200),
...
LOAD DATA INFILE '/tmp/temp_blacklist_logs_data_test_20240123.csv' INTO TABLE temp_blacklist_logs_table_20240123 FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

CREATE TEMPORARY TABLE temp_stb_logs_export_20240123
SELECT x.customer_name AS Customer_Name,
       ...
       x.model AS Model 
FROM (
    SELECT * FROM temp_act_logs_table_20240123
    UNION ALL
    SELECT * FROM temp_deact_logs_table_20240123
    UNION ALL 
    SELECT * FROM temp_message_logs_table_20240123
    UNION ALL 
    SELECT * FROM temp_fingerprint_logs_table_20240123
    UNION ALL 
    SELECT * FROM temp_pairing_logs_table_20240123 
    UNION ALL 
    SELECT * FROM temp_react_logs_table_20240123 
    UNION ALL 
    SELECT * FROM temp_blacklist_logs_table_20240123
) x 
...
SELECT * FROM temp_stb_logs_export_20240123
INTO OUTFILE '/tmp/stb_logs_20240123.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';
SELECT COALESCE(CONCAT(CONVERT(c.first_name USING utf8mb4),' ',coalesce(CONVERT(c.last_name USING utf8mb4),'')),'N/A')
customer_name,
    s.serial_number,
