...
SELECT * FROM temp_stb_logs_export_20240601_20240630
INTO OUTFILE '/tmp/stb_logs_20240601_20240630_1.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';


SELECT 'Customer_Name','Serial_Number','VC_Number','Action_Type','Package','Action_Done_By','Action_Done_On','CAS','Model' UNION ALL
SELECT * FROM temp_stb_logs_export_20240601_20240630 limit 500000, 500000
INTO OUTFILE '/tmp/stb_logs_20240601_20240630_2.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

SELECT 'Customer_Name','Serial_Number','VC_Number','Action_Type','Package','Action_Done_By','Action_Done_On','CAS','Model' UNION ALL
SELECT * FROM temp_stb_logs_export_20240601_20240630 limit 1000000, 500000
INTO OUTFILE '/tmp/stb_logs_20240601_20240630.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

SELECT 'Customer_Name','Serial_Number','VC_Number','Action_Type','Package','Action_Done_By','Action_Done_On','CAS','Model' UNION ALL
SELECT * FROM temp_stb_logs_export_20240601_20240630 limit 1500000, 500000
INTO OUTFILE '/tmp/stb_logs_20240601_20240630_4.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';

SELECT 'Customer_Name','Serial_Number','VC_Number','Action_Type','Package','Action_Done_By','Action_Done_On','CAS','Model' UNION ALL
SELECT * FROM temp_stb_logs_export_20240601_20240630 limit 2000000, 500000
INTO OUTFILE '/tmp/stb_logs_20240601_20240630_5.csv' FIELDS TERMINATED BY ',' OPTIONALLY ENCLOSED BY '"' LINES TERMINATED BY '
';